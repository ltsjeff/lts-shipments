...
shipments = [
    ...
    {"id": "SHP-036", "mfg": "RENO Lighting", "so": "S096107", "po": "5417", "ship": "2026-07-09", "carrier": "CCT (Cross Canada Transportation)", "tracking": "MISSING", "exp": "2026-07-17", "status": "In Transit", "desc": "OM - CASTLES RENO TYPE 1/1A/2/2B/3 — PO 5417 to RENO Jul 7 (SO S096107). RENO SHIPPED 1438 units Jul 9 (CCT, ETA 7-8 days → ~Jul 17); remainder on back order until 08/31/26.", "job": "OM - CASTLES RENO", "flag": "PARTIAL/BACKORDER: 1438 units shipped Jul 9 (CCT); no carrier PRO/tracking # on RENO notice yet — request it. Remainder backordered to Aug 31."},
...
HTML = HTML.replace("__LAST_UPDATED__", "Jul 9, 2026")
