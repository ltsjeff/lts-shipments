...
shipments = [
    ...
    {"id": "SHP-025", "mfg": "Nedco West Canada", "so": "5974859", "po": "5412", "ship": "", "carrier": "Ships to site (via RENO)", "tracking": "MISSING", "exp": "2026-07-15", "status": "Overdue", "desc": "MAPLE TOWERS - Nedco West Canada order 5974859, LTS PO 5412 (issued Jun 25). Ships to site. Expected Jul 15; no delivery confirmation.", "job": "Maple Towers", "flag": "OVERDUE 30 days + PO CORRECTED this run: was mapped to PO 5406 (which is BAPTIST SAMPLING LOTUS); QuickBooks shows PO 5412 = MAPLE TOWERS - NEDCO. No tracking on file"},
    {"id": "SHP-026", "mfg": "Artika (via Design Concepts)", "so": "", "po": "5408", "ship": "2026-07-01", "carrier": "carrier TBD (auto tracking)", "tracking": "MISSING", "exp": "2026-07-06", "status": "Overdue", "desc": "WOODLANDS ARTIKA EXTRAS TYPE G1 / N - Artika confirmed PO 5408 Jun 26 (in stock, ships 2-3 biz days, auto tracking). Presumed shipped ~Jul 1; no warehouse receipt after 3+ weeks.", "job": "Woodlands", "flag": "OVERDUE 39 days: expected Jul 6 (Artika PO 5408, Woodlands G1/N extras). No carrier assigned - escalate"},
    ...
    {"id": "SHP-046", "mfg": "CNA Lighting", "so": "", "po": "", "ship": "2026-07-10", "carrier": "TBD", "tracking": "MISSING", "exp": "", "status": "Overdue", "desc": "CNA Lighting invoice 51806 - product released Jul 10, carrier never confirmed. No ETA, no tracking, no warehouse receipt as of Aug 14 (35 days).", "job": "Unspecified (CNA inv 51806)", "flag": "OVERDUE 35 days: no carrier, no tracking, no GIT receipt since Jul 10 - trace with CNA or write off/reorder"},
    ...
    {"id": "SHP-054", "mfg": "RENO Lighting", "so": "", "po": "5436", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BE - RENO TYPE L1 - PO to RENO Jul 22 (QuickBooks); Yassine (RENO) acknowledged Jul 22, Jeff advised ~2-3 week lead, will email for release. Awaiting release/ETA.", "job": "Bridge & Elliot (RENO Type L1)", "flag": "STALE 23 days: PO 5436 (BE - RENO TYPE L1) issued Jul 22, no order confirmation or ship notice from RENO"},
    ...
    {"id": "SHP-059", "mfg": "Kuzco", "so": "", "po": "5432", "ship": "", "carrier": "Ships via Nuvo Sales", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BRIDGE AND ELLIOT KUZCO — Kuzco PO 5432 (via Nuvo Sales). Sharon @ Nuvo forwarded order confirmation with ESDs Jul 27. Awaiting ship/tracking.", "job": "Bridge & Elliot (Kuzco)", "flag": "STALE 23 days: PO 5432 (BRIDGE AND ELLIOT KUZCO, R1 same day) issued Jul 22 via Nuvo Sales - no ETA provided"},
    {"id": "SHP-060", "mfg": "Kuzco", "so": "", "po": "5441", "ship": "", "carrier": "Ships via Nuvo Sales", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "INTERGULF KINSLEY SHOWROOM — PO to Kuzco (via Nuvo Sales) Jul 27; Sharon @ Nuvo confirmed 'PO received & entered' Jul 27. Awaiting order confirmation, ESDs and ship/tracking.", "job": "Intergulf Kinsley Showroom", "flag": "STALE 18 days: PO 5441 (INTERGULF KINSLEY SHOWROOM) issued Jul 27 via Nuvo Sales - no ETA provided"},
    ...
    {"id": "SHP-081", "mfg": "RENO Lighting", "so": "S097737", "po": "5464", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BCNPHA COLUMBUS LODGE - RENO PO 5464 issued Aug 13, order confirmed as SO S097737. No ship notice yet.", "job": "BCNPHA COLUMBUS LODGE", "flag": "NEW this run: order confirmed Aug 13, awaiting ship notice (RENO typically ships in 1-3 days)"},
    {"id": "SHP-082", "mfg": "Kuzco", "so": "", "po": "5461", "ship": "2026-08-14", "carrier": "Loomis Express (via Nuvo Sales)", "tracking": "LSHP51130834", "exp": "2026-08-19", "status": "In Transit", "desc": "WHITE SPOT - KENSINGTON KUZCO - Kuzco PO 5461 via Nuvo Sales. Jeff chased lead time Aug 14; Nuvo (Christine) replied same day: 'Shipped today via Loomis Express.....LSHP51130834.' In transit, est. 3-5 business days.", "job": "WHITE SPOT - KENSINGTON KUZCO", "flag": "Resolved this run: was Order Placed with no ETA since Aug 12 - chase produced a same-day ship confirmation. Pattern: Kuzco/Nuvo POs only move when actively chased"},
    ...
    {"id": "SHP-092", "mfg": "Magic Lite", "so": "", "po": "5444", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "2026-08-12", "status": "Overdue", "desc": "Magic Lite PO 5444 - paid Aug 4 (transaction receipt issued by Pansy Ali). Jeff requested ETA Aug 6; Magic Lite replied Aug 7 'ETA Aug 12th.' Jeff asked for tracking same day - no tracking ever provided and no ship confirmation.", "job": "Unspecified (Magic Lite PO 5444)", "flag": "OVERDUE 3 days and PREPAID: cash already out the door Aug 4, promised ETA Aug 12 missed, tracking request from Aug 7 never answered. Prepaid + silent is the worst combination in this dataset - chase Pansy/Marquel directly"},
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 15, 2026")
