...
shipments = [
    ...
    {"id": "SHP-023", "mfg": "RENO Lighting", "so": "S091325", "po": "5303", "ship": "2026-06-26", "carrier": "Western Canada Express", "tracking": "MISSING", "exp": "2026-07-03", "status": "Due Today", "desc": "Store 9 / Stock \u2014 RENO SO# S091325 / PO# 5303 reshipped Jun 26 (WCE, ETA 7-8). Recurring stock SO. Latest partial in transit.", "job": "Store 9 / Stock", "flag": "No carrier tracking # on ship notice \u2014 request WCE PRO from RENO"},
    ...
    {"id": "SHP-027", "mfg": "CSC LED", "so": "4091094", "po": "", "ship": "2026-06-29", "carrier": "CSC prepaid (carrier TBD)", "tracking": "MISSING", "exp": "2026-07-06", "status": "In Transit", "desc": "CSC LED order 4091094 \u2014 placed Jun 25 (prepay & charge). Ships from Ontario warehouse within 2 biz days, ~5 biz days transit. Invoice 4091094 issued Jun 26. ETA ~Jul 6.", "job": "Unspecified (CSC 4091094)", "flag": "No tracking # yet \u2014 request from CSC (Viviane); identify job"},
...
HTML = HTML.replace("__LAST_UPDATED__", "Jul 3, 2026")
