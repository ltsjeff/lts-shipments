...
shipments = [
    ...
    {"id": "SHP-025", "mfg": "Nedco West Canada", "so": "5974859", "po": "5412", "ship": "", "carrier": "Ships to site (via RENO)", "tracking": "MISSING", "exp": "2026-07-15", "status": "Overdue", "desc": "MAPLE TOWERS - Nedco West Canada order 5974859, LTS PO 5412 (issued Jun 25). Ships to site. Expected Jul 15; no delivery confirmation.", "job": "Maple Towers", "flag": "OVERDUE 33 days + PO CORRECTED this run: was mapped to PO 5406 (which is BAPTIST SAMPLING LOTUS); QuickBooks shows PO 5412 = MAPLE TOWERS - NEDCO. No tracking on file"},
    {"id": "SHP-026", "mfg": "Artika (via Design Concepts)", "so": "", "po": "5408", "ship": "2026-07-01", "carrier": "carrier TBD (auto tracking)", "tracking": "MISSING", "exp": "2026-07-06", "status": "Overdue", "desc": "WOODLANDS ARTIKA EXTRAS TYPE G1 / N - Artika confirmed PO 5408 Jun 26 (in stock, ships 2-3 biz days, auto tracking). Presumed shipped ~Jul 1; no warehouse receipt after 3+ weeks.", "job": "Woodlands", "flag": "OVERDUE 42 days: expected Jul 6 (Artika PO 5408, Woodlands G1/N extras). No carrier assigned - escalate"},
    ...
    {"id": "SHP-046", "mfg": "CNA Lighting", "so": "", "po": "", "ship": "2026-07-10", "carrier": "TBD", "tracking": "MISSING", "exp": "", "status": "Overdue", "desc": "CNA Lighting invoice 51806 - product released Jul 10, carrier never confirmed. No ETA, no tracking, no warehouse receipt as of Aug 14 (35 days).", "job": "Unspecified (CNA inv 51806)", "flag": "OVERDUE 38 days: no carrier, no tracking, no GIT receipt since Jul 10 - trace with CNA or write off/reorder"},
    ...
    {"id": "SHP-059", "mfg": "Kuzco", "so": "", "po": "5432", "ship": "", "carrier": "Ships via Nuvo Sales", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BRIDGE AND ELLIOT KUZCO — Kuzco PO 5432 (via Nuvo Sales). Sharon @ Nuvo forwarded order confirmation with ESDs Jul 27. Awaiting ship/tracking.", "job": "Bridge & Elliot (Kuzco)", "flag": "STALE 26 days: PO 5432 (BRIDGE AND ELLIOT KUZCO, R1 same day) issued Jul 22 via Nuvo Sales - no ETA provided"},
    {"id": "SHP-060", "mfg": "Kuzco", "so": "", "po": "5441", "ship": "", "carrier": "Ships via Nuvo Sales", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "INTERGULF KINSLEY SHOWROOM — PO to Kuzco (via Nuvo Sales) Jul 27; Sharon @ Nuvo confirmed 'PO received & entered' Jul 27. Awaiting order confirmation, ESDs and ship/tracking.", "job": "Intergulf Kinsley Showroom", "flag": "STALE 21 days: PO 5441 (INTERGULF KINSLEY SHOWROOM) issued Jul 27 via Nuvo Sales - no ETA provided"},
    ...
    {"id": "SHP-064", "mfg": "Matteo Lighting", "so": "", "po": "5448", "ship": "", "carrier": "Artika fulfillment (carrier TBD)", "tracking": "MISSING", "exp": "2026-08-04", "status": "Overdue", "desc": "CHAMBER PROPERTIES FANS — PO 5448 (fan samples). Artika (Carla Torrez) advised order sent to fulfillment with ESD Aug 3-4; tracking to follow. Mfg attribution tentative (Artika fan program).", "job": "CHAMBER PROPERTIES FANS", "flag": "OVERDUE 13 days: expected Aug 4 (Artika fulfillment, PO 5448 CHAMBER PROPERTIES FANS). No tracking issued - escalate to Design Concepts"},
    {"id": "SHP-065", "mfg": "Nedco West Canada", "so": "S097172 (Nedco order 5996235)", "po": "5449", "ship": "2026-08-05", "carrier": "Day & Ross", "tracking": "WQ746286", "exp": "2026-08-11", "status": "Overdue", "desc": "HALLMARK ON THE LAKE - Nedco West Canada (Amber Larsen, Kelowna) order 5996235, RENO SO S097172, Nedco PO WTX 00475D. Shipped complete Aug 5 via Day & Ross, waybill WQ746286, ETA 4-5 days. Includes 123x R31104 RENO-S12R-MCCT-WH (12in round MCCT white). Ship-to LTS Canada Warehouse, 105-8288 North Fraser Way, Burnaby.", "job": "HALLMARK ON THE LAKE", "flag": "OVERDUE 8 days - Hallmark on the Lake, Nedco order 5996235 / PO 5449, waybill WQ746286 (ship Aug 5, exp Aug 11). Nedco is also silent on PO 5465 (SHP-079) - same branch, same non-response pattern."},
    ...
    {"id": "SHP-069", "mfg": "RENO Lighting", "so": "S097428", "po": "5454", "ship": "2026-08-10", "carrier": "Purolator (Small Parcel)", "tracking": "520691119819", "exp": "2026-08-17", "status": "Overdue", "desc": "RENO S097428 / PO 5454 — shipped Aug 10 (Purolator Small Parcel, ETA 5-7). Expected Aug 15-17. No GIT warehouse receipt and no delivery confirmation as of Aug 18. Now past ETA.", "job": "OM Castle Parkade (Extras)", "flag": "OVERDUE 2 days - OM Castle Parkade extras, Purolator 520691119819 (ship Aug 10, ETA 5-7, exp Aug 17). No GIT receipt. Second Castle Parkade shipment to slip; chase Purolator and Reno together."},
    ...
    {"id": "SHP-073", "mfg": "RENO Lighting", "so": "S097586", "po": "5456", "ship": "2026-08-12", "carrier": "Purolator (Small Parcel)", "tracking": "520695648581", "exp": "2026-08-18", "status": "Overdue", "desc": "MARCON RAVENNA TYPE A1 - RENO S097586 / PO 5456, shipped Aug 12 (Purolator Small Parcel 520695648581, ETA 5-7), invoice IN103110, slip WH/OUT/40762. Expected Aug 18. No GIT receipt as of Aug 19.", "job": "MARCON RAVENNA TYPE A1", "flag": "OVERDUE 1 day - Purolator 520695648581 past ETA with no GIT receipt. Outer edge of the 5-7 day window is Aug 19, so this may still land today; check Purolator tracking before escalating to Reno."},
    ...
    {"id": "SHP-078", "mfg": "Lotus", "so": "", "po": "5469", "ship": "", "carrier": "Local pickup (Delta, BC)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "SAMPLES #3 - Lotus PO 5469 issued Aug 14 (sent twice). No acknowledgement or pickup confirmation yet.", "job": "Samples #3 (Lotus)", "flag": "STALE 6 days - PO 5469 SAMPLES #3 sent to Lotus Aug 13, no confirmation or pickup-ready notice. Batch with PO 5463 and 5478 for a single Delta pickup."},
    {"id": "SHP-079", "mfg": "Nedco West Canada", "so": "", "po": "5465", "ship": "", "carrier": "Ships to site (via Nedco)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "ORR DEV - REPLACEMENT SISTEMALUX - Nedco West Canada PO 5465 issued Aug 14. No acknowledgement or ETA yet.", "job": "ORR DEV - REPLACEMENT SISTEMALUX", "flag": "STALE 6 days - PO 5465 ORR DEV replacement Sistemalux sent to amber.larsen@nedco.ca Aug 13, no acknowledgement and no order number. Nedco has a second late file open (PO 5449, SHP-065). Escalate above Amber."},
    {"id": "SHP-080", "mfg": "CNA Lighting", "so": "", "po": "5468", "ship": "", "carrier": "Local pickup (Burnaby)", "tracking": "", "exp": "", "status": "Order Placed", "desc": "WHITESPOT KENSINGTON CNA - CNA International PO 5468 issued Aug 14. No pickup confirmation yet.", "job": "WHITESPOT KENSINGTON CNA", "flag": "STALE 6 days - PO 5468 WHITESPOT KENSINGTON CNA sent Aug 13. Alan confirmed receipt but no pickup date. Three CNA pickup orders now open (5468, 5472, 5475) - collect in one Burnaby run."},
    {"id": "SHP-081", "mfg": "RENO Lighting", "so": "S097737", "po": "5464", "ship": "2026-08-17", "carrier": "Day & Ross", "tracking": "A11881775", "exp": "2026-08-22", "status": "In Transit", "desc": "RENO S097737 / PO 5464 — shipped Aug 17 (Day & Ross, ETA 4-5). Expected Aug 21-22. Order confirmation received Aug 14 from Yassine.", "job": "BCNPHA COLUMBUS LODGE", "flag": ""},
    {"id": "SHP-082", "mfg": "Kuzco", "so": "", "po": "5461", "ship": "2026-08-14", "carrier": "Loomis Express", "tracking": "LSHP51130834", "exp": "2026-08-19", "status": "Due Today", "desc": "WHITE SPOT - KENSINGTON KUZCO - Kuzco via Nuvo Sales, PO 5461, invoice C-INV00108844 ($2,785.86), shipped Aug 14 via Loomis Express LSHP51130834. Expected Aug 19.", "job": "WHITE SPOT - KENSINGTON KUZCO", "flag": "DUE TODAY - Loomis LSHP51130834. Reno/Nuvo notice carried no explicit ETA; Aug 19 is derived from Loomis BC ground transit. Confirm delivery today or it flips Overdue tomorrow."},
    {"id": "SHP-083", "mfg": "Lotus", "so": "", "po": "5463", "ship": "", "carrier": "Local pickup (Delta, BC)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BAPTIST SAMPLES - LOTUS - Lotus PO 5463 issued Aug 12. BLOCKED awaiting revised PO: SC-DL12-D06H-A1-61RE-WH is only sold in boxes of 28, and colour temperature unconfirmed on KVG-24096-DWJ and LBL-COB-320.", "job": "BAPTIST SAMPLES - LOTUS", "flag": "STALE 7 days - PO 5463 BAPTIST SAMPLES - LOTUS sent Aug 12, revised Aug 17, still no pickup-ready confirmation. Four Lotus sample POs are now open at once (5451, 5463, 5469, 5470) - consolidate into one pickup run."},
    ...
    {"id": "SHP-087", "mfg": "Commercial Lighting", "so": "1806311", "po": "", "ship": "2026-08-14", "carrier": "Uber (courier pickup)", "tracking": "", "exp": "2026-08-14", "status": "Delivered", "desc": "FOOT LOCKER - Sensor Switch WSXA MWO PDT WH (multi-zone dual-tech). Jeff asked Sean Loban Aug 14 for same-hour stock; Sean confirmed order 1806311 and had Adelaide prep it for pickup by 4:30pm. Uber driver collected within 5-10 min. Same-day DELIVERED.", "job": "FOOT LOCKER", "flag": ""},
    {"id": "SHP-088", "mfg": "Gescan (Sonepar)", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "FOOT LOCKER - PO issued to Gescan (Naveen Vadlamudi) Aug 14 via QuickBooks. No acknowledgement, no ETA, no PO# captured on the notification.", "job": "FOOT LOCKER", "flag": "NEW this run: issued Aug 14, no vendor acknowledgement. Gescan has a second silent PO in this dataset (SHP-041, SHP-070) - chase both together"},
    {"id": "SHP-089", "mfg": "CNA Lighting", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BCNPHA COLUMBUS LODGE CNA - PO issued to CNA (orders@cnalighting.com) Aug 14. Alan Yang confirmed same day: 'Confirmed.' No ETA given.", "job": "BCNPHA COLUMBUS LODGE", "flag": "NEW this run: confirmed by vendor Aug 14 but no ETA. CNA typically fulfils as local Burnaby pickup - ask whether this is pickup or ship"},
    {"id": "SHP-090", "mfg": "Ortech (via Crown Distributors)", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "2026-08-28", "status": "Order Placed", "desc": "BCNPHA COLUMBUS LODGE ORTECH - PO issued to Crown Distributors Aug 14. Nav Gill replied same day: 'The ETA for OD-C618 is about 1-2 weeks. Will ship as soon as stock arrives.' Jeff noted internally 'lead time np we got 251 we can grab from the hallmark jobs.'", "job": "BCNPHA COLUMBUS LODGE", "flag": "Backorder: OD-C618 not in stock, 1-2 week ETA (est. Aug 28). Mitigation already identified - 251 units available to pull from the Hallmark job if Columbus Lodge needs them sooner"},
    ...
    {"id": "SHP-092", "mfg": "Magic Lite", "so": "", "po": "5444", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "2026-08-12", "status": "Overdue", "desc": "Magic Lite PO 5444 - paid Aug 4 (transaction receipt issued by Pansy Ali). Jeff requested ETA Aug 6; Magic Lite replied Aug 7 'ETA Aug 12th.' Jeff asked for tracking same day - no tracking ever provided and no ship confirmation.", "job": "Unspecified (Magic Lite PO 5444)", "flag": "OVERDUE 5 days and PREPAID: cash already out the door Aug 4, promised ETA Aug 12 missed, tracking request from Aug 7 never answered. Prepaid + silent is the worst combination in this dataset - chase Pansy/Marquel directly"},
    ...
    {"id": "SHP-094", "mfg": "Z-Lite (via Lejend Marketing)", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "Z-Lite via Lejend Marketing (Len Stam) — WHITE SPOT KENSINGTON ZLITE. PO sent Aug 14. Blocked: Len needs a completed credit card form before processing. Aug 18 Len still asking which email the original order came from. Not yet in production.", "job": "WHITE SPOT KENSINGTON ZLITE", "flag": "BLOCKED 4 days on credit card form — James to complete and return; order not yet placed with Z-Lite"},
    {"id": "SHP-095", "mfg": "Artika (via Design Concepts)", "so": "", "po": "5457", "ship": "", "carrier": "carrier TBD (auto tracking)", "tracking": "MISSING", "exp": "2026-08-18", "status": "Overdue", "desc": "Artika via Design Concepts — PO 5457 sent Aug 11. Carla Torrez Aug 13: 'sent to fulfillment, in stock, will ship in 1-3 business days, tracking automatic.' No tracking email received as of Aug 18.", "job": "MARCON RAVENNA TYPE B T1", "flag": "OVERDUE 1 day past ship promise (PO 5457 sent Aug 11; Carla confirmed in-stock, 1-3 day ship, automatic tracking). Still no tracking Aug 19. Sister PO 5477 (SHP-105) is on the same promise and due Aug 21 - chase Veruska/Carla on both in one email."},
    {"id": "SHP-096", "mfg": "Sylvania/Ledvance (via Save More / Maxilite)", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "2026-08-22", "status": "Order Placed", "desc": "WS KENSINGTON MAXILITE - PO issued to Save More Lighting (Maxilite fulfillment) Aug 12; vendor quoted roughly a 10-day lead, so expected ~Aug 22. No order confirmation number captured.", "job": "WS KENSINGTON MAXILITE", "flag": "NEW this run: third open Save More/Maxilite order alongside SHP-039 and SHP-072, both of which are long stale with no ETA. Same vendor, same failure mode - chase all three in one email"},
    ...
    {"id": "SHP-102", "mfg": "Light Efficient Design", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "Light Efficient Design order acknowledged Aug 10: 'Your order has been received and will be processed by a Project Associate.' No ship confirmation, no ETA, no carrier as of Aug 17.", "job": "Unspecified (Light Efficient Design)", "flag": "STALE 9 days - Light Efficient Design acknowledged the order Aug 10 ('will be processed by a Project Associate') and has produced no ship date, ETA or carrier since. No PO or job identified on the LTS side either - identify the job before this ages further."},
    {"id": "SHP-103", "mfg": "RENO Lighting", "so": "S097847", "po": "5476", "ship": "2026-08-18", "carrier": "Purolator (Small Parcel)", "tracking": "520705431861", "exp": "2026-08-25", "status": "In Transit", "desc": "RENO S097847 / PO 5476 - shipped Aug 18 (Purolator Small Parcel, ETA 5-7). Expected Aug 23-25. PO sent to Reno Aug 17 for T8 EXTRAS. Aug 19: Purolator tracking 520705431861 now confirmed off the Reno slip WH/OUT/41007.", "job": "T8 EXTRAS", "flag": ""},
    {"id": "SHP-104", "mfg": "Lotus", "so": "", "po": "5478", "ship": "2026-08-18", "carrier": "TBD (Lotus Delta BC)", "tracking": "", "exp": "", "status": "Order Placed", "desc": "Lotus LED Lights PO sent Aug 18 for HUDDY WASHROOMS. Awaiting order-desk confirmation and ETA from Sharon Ma. Lotus typically ships/pickup-ready from Delta BC within 1-2 days.", "job": "HUDDY WASHROOMS", "flag": "STALE 1 day - PO 5478 HUDDY WASHROOMS sent to Lotus Aug 18. Sharon Ma has not confirmed; RIP5 plates available but 2x RIP312 still being located, so expect a partial."},
    {"id": "SHP-105", "mfg": "Artika (via Design Concepts)", "so": "", "po": "5477", "ship": "2026-08-17", "carrier": "TBD", "tracking": "", "exp": "2026-08-21", "status": "Order Placed", "desc": "Artika via Design Concepts (Veruska Ellestad) — PO 5477 sent Aug 17 for MARCON RAVENNA TYPE T1. Jorge Ledesma Aug 17: 'sales order attached, scheduled to ship in 2-3 days, automated tracking email to follow.' Expect tracking ~Aug 20-21.", "job": "MARCON RAVENNA TYPE T1", "flag": "Watch for the automated Artika tracking email by Aug 21. Sister PO 5457 (SHP-095) already blew the same 1-3 day ship promise, so treat the Aug 21 date as optimistic."},
    {"id": "SHP-106", "mfg": "CNA Lighting", "so": "081726", "po": "5475", "ship": "2026-08-17", "carrier": "Local pickup (Burnaby)", "tracking": "", "exp": "2026-08-19", "status": "Order Placed", "desc": "CNA Lighting bankcard order #081726 placed Aug 17 ($382.78, approved on account). PO sent same day for CNA A19 1216 EXTRAS. Local pickup order — arrange collection.", "job": "CNA A19 1216 EXTRAS", "flag": "PICKUP DUE TODAY - CNA bankcard order #081726 (PO 5475, $382.78) ready at CNA Burnaby. Combine with PO 5468 and 5472 pickups in the same trip."},
]
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 19, 2026")
