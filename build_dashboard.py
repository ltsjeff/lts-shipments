...
shipments = [
    ...
    {"id": "SHP-022", "mfg": "Onlumi (Shenzhen)", "so": "", "po": "", "ship": "2026-06-25", "carrier": "DHL", "tracking": "7754899854", "exp": "2026-07-02", "status": "Overdue", "desc": "Onlumi (Shenzhen) strip/connectors — DHL waybill 7754899854 from Shenzhen Onlumi. Customs/duty paid Jun 26. Expected ~Jul 2; no warehouse receipt yet as of Jul 9. OVERDUE — follow up.", "job": "Unspecified (Onlumi strip/connectors)", "flag": "OVERDUE 7 days: overseas DHL (waybill 7754899854); customs cleared Jun 26; no GIT receipt yet — confirm delivery / trace"},
    ...
    {"id": "SHP-036", "mfg": "RENO Lighting", "so": "S096107", "po": "5417", "ship": "2026-07-09", "carrier": "CCT (Cross Canada Transportation)", "tracking": "CC0997981", "exp": "2026-07-17", "status": "In Transit", "desc": "OM - CASTLES RENO TYPE 1/1A/2/2B/3 — PO 5417 to RENO Jul 7 (SO S096107). RENO SHIPPED 1438 units Jul 9 (CCT, tracking CC0997981, ref WH/OUT/39244, ETA 7-8 days → ~Jul 17); remainder on back order until 08/31/26.", "job": "OM - CASTLES RENO", "flag": "PARTIAL/BACKORDER: 1438 units shipped Jul 9 (CCT #CC0997981); remainder backordered to Aug 31 — track delivery ~Jul 17."},
    {"id": "SHP-037", "mfg": "RENO Lighting", "so": "", "po": "", "ship": "2026-07-06", "carrier": "Western Canada Express", "tracking": "", "exp": "2026-07-06", "status": "Delivered", "desc": "GIT receipt Jul 6 — 'Western Canada Express delivered four pallets from Reno.' Some boxes damaged; GIT signed as damaged and driver took photos. Two pages of packing slip attached.", "job": "Unspecified (Reno)", "flag": "DAMAGE EXCEPTION: some boxes damaged on arrival — signed as damaged, photos taken; file carrier/RENO claim & tag pallets to job/PO"},
    ...
    {"id": "SHP-043", "mfg": "RENO Lighting", "so": "S096251", "po": "5420", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "CF - 250HOWE FL16 RENO — PO 5420 issued to RENO Jul 10 (QB PO to Reno Lighting same day); RENO returned order confirmation SO# S096251 Jul 10. No ship notice yet.", "job": "CF - 250HOWE FL16 RENO", "flag": "New PO Jul 10 — await RENO ship notice / ETA"},
]
...
HTML = HTML.replace("__LAST_UPDATED__", "Jul 10, 2026")
