...
shipments = [
    ...
    {"id": "SHP-043", "mfg": "RENO Lighting", "so": "S096251", "po": "5420", "ship": "2026-07-22", "carrier": "Day & Ross", "tracking": "AC3129246", "exp": "2026-07-27", "status": "Overdue", "desc": "CF - 250HOWE FL16 RENO - PO 5420 (SO S096251) released and SHIPPED Jul 22 (Day & Ross, tracking AC3129246, ref WH/OUT/39835, ETA 5 days). Track at dayross.com; ETA ~Jul 27.", "job": "CF - 250HOWE FL16 RENO", "flag": "OVERDUE: Day & Ross #AC3129246 shipped Jul 22, ETA Jul 27 now 9 days elapsed and no GIT warehouse receipt logged; Jeff chased RENO/Andrew Jul 29 - trace Day & Ross #AC3129246 and confirm delivery to 250 Howe. Aug 11: two Reno pallets received via Day & Ross (#A11733440, incl. one 8ft, SHP-074) - check whether this closes 5420"},
    ...
    {"id": "SHP-073", "mfg": "RENO Lighting", "so": "S097586", "po": "5456", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "MARCON RAVENNA (Type A1) — LTS PO 5456 / RENO SO S097586. Yassine (RENO) returned order confirmation Aug 11 (Order - S097586.pdf). Placed alongside the Aug 11 Marcon Ravenna QuickBooks POs (Type A1 / Type B T1). No release/ship notice yet.", "job": "Marcon Ravenna", "flag": "NEW this run: order confirmed Aug 11 (RENO SO S097586); job tentatively Marcon Ravenna Type A1 — confirm and follow up for release date/ETA"},
    {"id": "SHP-074", "mfg": "RENO Lighting", "so": "", "po": "", "ship": "2026-08-11", "carrier": "Day & Ross", "tracking": "A11733440", "exp": "2026-08-11", "status": "Delivered", "desc": "GIT (Simon) receipt Aug 11 — Day & Ross delivered two pallets from Reno (one 8ft long). Carrier tracking A11733440. New warehouse arrival; LTS PO/job not identified on receipt. The 8ft pallet suggests linear/continuous-run fixtures.", "job": "Unspecified (Reno via Day & Ross)", "flag": "NEW this run: two Reno pallets received Aug 11 (Day & Ross #A11733440, incl. one 8ft) — tag at warehouse to identify LTS job/PO; may reconcile CF-250HOWE/PO 5420 (overdue, SHP-043)"},
]
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 11, 2026")
