...
shipments = [
    ...
    {"id": "SHP-077", "mfg": "Lotus", "so": "", "po": "5470", "ship": "2026-08-14", "carrier": "Customer pickup (Delta, BC)", "tracking": "", "exp": "2026-08-14", "status": "Due Today", "desc": "SAMPLE FOR OFFICE - Lotus PO 5470 issued Aug 14. Lotus confirmed same day: 'ready for pick up today before 4pm, and no freight charges.' Awaiting pickup.", "job": "SAMPLE FOR OFFICE (Lotus)", "flag": "DUE TODAY: ready at Lotus Delta before 4pm Aug 14, no freight charge. Needs someone dispatched today or it waits the weekend"},
    ...
    {"id": "SHP-082", "mfg": "Kuzco", "so": "", "po": "5461", "ship": "", "carrier": "Ships via Nuvo Sales", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "WHITE SPOT - KENSINGTON KUZCO - Kuzco PO 5461 issued Aug 12 via Nuvo Sales. Nuvo replied 'Received and entered, thank you!' No ETA, no ship confirmation.", "job": "WHITE SPOT - KENSINGTON KUZCO", "flag": "NEW this run: entered Aug 12 with NO ETA. Kuzco POs in this dataset are the worst offenders for silent stalling (5411 at 50 days, 5432 at 23) - demand a ship date"},
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 14, 2026")
