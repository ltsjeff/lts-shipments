...
shipments = [
    ...
    {"id": "SHP-069", "mfg": "RENO Lighting", "so": "S097428", "po": "5454", "ship": "2026-08-10", "carrier": "Purolator (Small Parcel)", "tracking": "520691119819", "exp": "2026-08-17", "status": "Due Today", "desc": "OM CASTLE PK EXTRAS — LTS PO 5454 / RENO SO S097428. RENO SHIPPED today Aug 10 (Purolator Small Parcel, tracking 520691119819, ref WH/OUT/40634, ETA 5-7 days). Track at purolator.com; expected ~Aug 17.", "job": "OM Castle Parkade (Extras)", "flag": "DUE TODAY (Aug 17) - Purolator 520691119819, end of the 5-7 day ETA window. No GIT receipt yet this morning; if nothing lands today this flips Overdue tomorrow"},
    ...
    {"id": "SHP-073", "mfg": "RENO Lighting", "so": "S097586", "po": "5456", "ship": "2026-08-12", "carrier": "Purolator (Small Parcel)", "tracking": "520695648581", "exp": "2026-08-19", "status": "In Transit", "desc": "MARCON RAVENNA TYPE A1 - RENO SO# S097586 / PO# 5456 SHIPPED Aug 12 (Purolator Small Parcel, tracking 520695648581, ETA 5-7 days). Delivery slip WH/OUT/40762. RENO invoice IN103110 issued Aug 13.", "job": "MARCON RAVENNA TYPE A1", "flag": "STATUS CHANGE this run: was Order Placed, now In Transit (shipped Aug 12, tracking 520695648581); ETA window Aug 17-19"},
    ...
    {"id": "SHP-075", "mfg": "RENO Lighting", "so": "S097734", "po": "5467", "ship": "2026-08-14", "carrier": "Purolator (Small Parcel)", "tracking": "520699905698", "exp": "2026-08-21", "status": "In Transit", "desc": "WHITESPOT KENSINGTON RENO - RENO SO# S097734 / PO# 5467 shipped Aug 14 (Purolator Small Parcel, tracking 520699905698, ETA 5-7 days). Delivery slip WH/OUT/40879 to Luma Tech Solutions Canada Ltd. PO issued and shipped same day.", "job": "WHITESPOT KENSINGTON RENO", "flag": "NEW this run: shipped Aug 14. Line items not itemized in the ship notice (delivery slip PDF only) - confirm contents against PO on arrival"},
    {"id": "SHP-076", "mfg": "RENO Lighting", "so": "S097646", "po": "5462", "ship": "2026-08-14", "carrier": "Purolator (Small Parcel)", "tracking": "520699854078", "exp": "2026-08-21", "status": "In Transit", "desc": "Baptist Samples - RENO - RENO SO# S097646 / PO# 5462 shipped Aug 14 (Purolator Small Parcel, tracking 520699854078, ETA 5-7 days). Delivery slip WH/OUT/40884.", "job": "Baptist Samples - RENO", "flag": "NEW this run: shipped Aug 14. Sample order for Baptist Housing - route to Jeff, not to general stock"},
    ...
    {"id": "SHP-081", "mfg": "RENO Lighting", "so": "S097737", "po": "5464", "ship": "2026-08-17", "carrier": "Day & Ross", "tracking": "A11881775", "exp": "2026-08-22", "status": "In Transit", "desc": "BCNPHA COLUMBUS LODGE - RENO PO 5464 issued Aug 13, confirmed as SO S097737. SHIPPED today Aug 17 (Day & Ross, tracking A11881775, ETA 4-5 days, ref WH/OUT/40933). Track at dayross.com; expected ~Aug 22.", "job": "BCNPHA COLUMBUS LODGE", "flag": "STATUS CHANGE this run: Order Placed -> In Transit. RENO held to its 1-3 day pattern (PO Aug 13, shipped Aug 17). Ortech half of this job (SHP-090) is still backordered to ~Aug 28 - Columbus Lodge will land in two waves"},
    {"id": "SHP-082", "mfg": "Kuzco", "so": "", "po": "5461", "ship": "2026-08-14", "carrier": "Loomis Express (via Nuvo Sales)", "tracking": "LSHP51130834", "exp": "2026-08-19", "status": "In Transit", "desc": "WHITE SPOT - KENSINGTON KUZCO - Kuzco PO 5461 via Nuvo Sales. Jeff chased lead time Aug 14; Nuvo (Christine) replied same day: 'Shipped today via Loomis Express.....LSHP51130834.' In transit, est. 3-5 business days.", "job": "WHITE SPOT - KENSINGTON KUZCO", "flag": "In transit - Loomis LSHP51130834, ETA ~Aug 19. Kuzco invoice C-INV00108844 ($2,785.86, due Sep 13) issued Aug 17, which confirms the goods actually left. Pattern: Kuzco/Nuvo POs only move when actively chased"},
    ...
    {"id": "SHP-094", "mfg": "Z-Lite (via Lejend Marketing)", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "WHITE SPOT KENSINGTON ZLITE - PO issued to Z Lite (Len Stam, lstam@lejendmarketing.com) Aug 14. Jeff chased for confirmation/ETA Aug 14 and again Aug 17: 'checking in to see when this order may be shipped out, client looking to get this going as soon as possible.' No vendor reply on either.", "job": "WHITE SPOT KENSINGTON ZLITE", "flag": "NEW this run + SILENT VENDOR: 3 days, two chases, zero response from Z-Lite/Lejend. Client is waiting on the ETA before LTS can submit a schedule. Escalate past Len or source an alternate"},
    {"id": "SHP-095", "mfg": "Artika (via Design Concepts)", "so": "", "po": "5457", "ship": "", "carrier": "carrier TBD (auto tracking)", "tracking": "MISSING", "exp": "2026-08-18", "status": "Order Placed", "desc": "MARCON RAVENNA TYPE B T1 - Artika PO 5457. Vendor advised Aug 13 the item is 'in stock and will ship in 1-3 business days' with tracking to follow automatically. No ship notice or tracking received yet.", "job": "MARCON RAVENNA TYPE B T1", "flag": "NEW this run: promised ship window (1-3 biz days from Aug 13) closes Aug 18. Artika has already missed one promised date on PO 5448 (SHP-064, 13 days overdue) - do not assume this one ships on time"},
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 17, 2026")
