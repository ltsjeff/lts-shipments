...
shipments = [
    ...
    {"id": "SHP-014", "mfg": "RENO Lighting", "so": "S095362", "po": "5399", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "MARCON RAVENNA 7\" SM — PO issued to RENO Jun 17; order confirmed. No ship notice yet as of Jul 13 (26 days).", "job": "MARCON RAVENNA 7\" SM", "flag": "STALE 61 days: RENO order confirmed Jun 17 (SO S095362 / PO 5399 MARCON RAVENNA 7\" SM), still no ship notice. Escalate - possible dead/duplicated order vs PO 5456 which shipped Aug 12"},
    ...
    {"id": "SHP-054", "mfg": "RENO Lighting", "so": "", "po": "5436", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BE - RENO TYPE L1 - PO to RENO Jul 22 (QuickBooks); Yassine (RENO) acknowledged Jul 22, Jeff advised ~2-3 week lead, will email for release. Awaiting release/ETA.", "job": "Bridge & Elliot (RENO Type L1)", "flag": "STALE 26 days: PO 5436 (BE - RENO TYPE L1) issued Jul 22, no order confirmation or ship notice from RENO"},
    ...
    {"id": "SHP-065", "mfg": "Nedco West Canada", "so": "S097172 (Nedco order 5996235)", "po": "5449", "ship": "2026-08-05", "carrier": "Day & Ross", "tracking": "WQ746286", "exp": "2026-08-11", "status": "Overdue", "desc": "HALLMARK ON THE LAKE - Nedco West Canada (Amber Larsen, Kelowna) order 5996235, RENO SO S097172, Nedco PO WTX 00475D. Shipped complete Aug 5 via Day & Ross, waybill WQ746286, ETA 4-5 days. Includes 123x R31104 RENO-S12R-MCCT-WH (12in round MCCT white). Ship-to LTS Canada Warehouse, 105-8288 North Fraser Way, Burnaby.", "job": "HALLMARK ON THE LAKE", "flag": "OVERDUE 6 days - ETA was Aug 11, no GIT receipt confirmation. Waybill WQ746286 now known: trace with Day & Ross and confirm with GIT whether this landed among the unlabelled pallets."},
    ...
    {"id": "SHP-069", "mfg": "RENO Lighting", "so": "S097428", "po": "5454", "ship": "2026-08-10", "carrier": "Purolator (Small Parcel)", "tracking": "520691119819", "exp": "2026-08-17", "status": "Overdue", "desc": "RENO S097428 / PO 5454 — shipped Aug 10 (Purolator Small Parcel, ETA 5-7). Expected Aug 15-17. No GIT warehouse receipt and no delivery confirmation as of Aug 18. Now past ETA.", "job": "OM Castle Parkade (Extras)", "flag": "OVERDUE 1 day past ETA — chase Purolator tracking + confirm with GIT (Simon/Thanh)"},
    ...
    {"id": "SHP-073", "mfg": "RENO Lighting", "so": "S097586", "po": "5456", "ship": "2026-08-12", "carrier": "Purolator (Small Parcel)", "tracking": "520695648581", "exp": "2026-08-18", "status": "Due Today", "desc": "RENO S097586 / PO 5456 — shipped Aug 12 (Purolator Small Parcel, ETA 5-7). Upper-bound ETA lands Aug 18-19. Due today.", "job": "MARCON RAVENNA TYPE A1", "flag": "Due today — watch for GIT receipt; no carrier tracking # in RENO notice"},
    ...
    {"id": "SHP-078", "mfg": "Lotus", "so": "", "po": "5469", "ship": "", "carrier": "Local pickup (Delta, BC)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "SAMPLES #3 - Lotus PO 5469 issued Aug 14 (sent twice). No acknowledgement or pickup confirmation yet.", "job": "Samples #3 (Lotus)", "flag": "NEW this run: PO issued today. Watch for the same box-quantity/colour-temp clarifications that delayed Samples #2 (PO 5451 needed 3 revisions)"},
    {"id": "SHP-079", "mfg": "Nedco West Canada", "so": "", "po": "5465", "ship": "", "carrier": "Ships to site (via Nedco)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "ORR DEV - REPLACEMENT SISTEMALUX - Nedco West Canada PO 5465 issued Aug 14. No acknowledgement or ETA yet.", "job": "ORR DEV - REPLACEMENT SISTEMALUX", "flag": "NEW this run: PO issued today. Sistemalux replacement - confirm Nedco has stock, these are typically long-lead"},
    {"id": "SHP-080", "mfg": "CNA Lighting", "so": "", "po": "5468", "ship": "", "carrier": "Local pickup (Burnaby)", "tracking": "", "exp": "", "status": "Order Placed", "desc": "WHITESPOT KENSINGTON CNA - CNA International PO 5468 issued Aug 14. No pickup confirmation yet.", "job": "WHITESPOT KENSINGTON CNA", "flag": "NEW this run: PO issued today. CNA usually confirms pickup same/next day - chase Aug 15 if silent"},
    ...
    {"id": "SHP-082", "mfg": "Kuzco", "so": "", "po": "5461", "ship": "2026-08-14", "carrier": "Loomis Express", "tracking": "LSHP51130834", "exp": "2026-08-19", "status": "In Transit", "desc": "Kuzco via Nuvo Sales — Christine confirmed Aug 14: 'Shipped today via Loomis Express LSHP51130834.' Expected ~Aug 19.", "job": "WHITE SPOT - KENSINGTON KUZCO", "flag": ""},
    {"id": "SHP-083", "mfg": "Lotus", "so": "", "po": "5463", "ship": "", "carrier": "Local pickup (Delta, BC)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BAPTIST SAMPLES - LOTUS - Lotus PO 5463 issued Aug 12. BLOCKED awaiting revised PO: SC-DL12-D06H-A1-61RE-WH is only sold in boxes of 28, and colour temperature unconfirmed on KVG-24096-DWJ and LBL-COB-320.", "job": "BAPTIST SAMPLES - LOTUS", "flag": "BLOCKED: Lotus will not ship until LTS reissues the PO (box-of-28 minimum + unconfirmed colour temps on 2 SKUs). Supersedes SHP-031/SHP-034. Action sits with LTS, not the vendor"},
    ...
    {"id": "SHP-102", "mfg": "Light Efficient Design", "so": "", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "Light Efficient Design order acknowledged Aug 10: 'Your order has been received and will be processed by a Project Associate.' No ship confirmation, no ETA, no carrier as of Aug 17.", "job": "Unspecified (Light Efficient Design)", "flag": "7 days since acknowledgement with no ship date or ETA. Chase LED for order status and ETA."},
    {"id": "SHP-103", "mfg": "RENO Lighting", "so": "S097847", "po": "5476", "ship": "2026-08-18", "carrier": "Purolator (Small Parcel)", "tracking": "MISSING", "exp": "2026-08-25", "status": "In Transit", "desc": "RENO S097847 / PO 5476 — shipped Aug 18 (Purolator Small Parcel, ETA 5-7). Expected Aug 23-25. PO sent to Reno Aug 17 for T8 EXTRAS.", "job": "T8 EXTRAS", "flag": "No carrier tracking # supplied in RENO shipped notice"},
    {"id": "SHP-104", "mfg": "Lotus", "so": "", "po": "5478", "ship": "2026-08-18", "carrier": "TBD (Lotus Delta BC)", "tracking": "", "exp": "", "status": "Order Placed", "desc": "Lotus LED Lights PO sent Aug 18 for HUDDY WASHROOMS. Awaiting order-desk confirmation and ETA from Sharon Ma. Lotus typically ships/pickup-ready from Delta BC within 1-2 days.", "job": "HUDDY WASHROOMS", "flag": "New PO today — no ETA yet"},
    {"id": "SHP-105", "mfg": "Artika (via Design Concepts)", "so": "", "po": "5477", "ship": "2026-08-17", "carrier": "TBD", "tracking": "", "exp": "2026-08-21", "status": "Order Placed", "desc": "Artika via Design Concepts (Veruska Ellestad) — PO 5477 sent Aug 17 for MARCON RAVENNA TYPE T1. Jorge Ledesma Aug 17: 'sales order attached, scheduled to ship in 2-3 days, automated tracking email to follow.' Expect tracking ~Aug 20-21.", "job": "MARCON RAVENNA TYPE T1", "flag": "Watch for automated Artika tracking email by Aug 21 — sister PO 5457 already slipped its ship promise"},
    {"id": "SHP-106", "mfg": "CNA Lighting", "so": "081726", "po": "5475", "ship": "2026-08-17", "carrier": "Local pickup (Burnaby)", "tracking": "", "exp": "2026-08-19", "status": "Order Placed", "desc": "CNA Lighting bankcard order #081726 placed Aug 17 ($382.78, approved on account). PO sent same day for CNA A19 1216 EXTRAS. Local pickup order — arrange collection.", "job": "CNA A19 1216 EXTRAS", "flag": "Local pickup — schedule collection from CNA Burnaby"},
]
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 18, 2026")
