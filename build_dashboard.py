...
shipments = [
    ...
    {"id": "SHP-056", "mfg": "RENO Lighting", "so": "S096887", "po": "5438", "ship": "2026-07-27", "carrier": "Day & Ross", "tracking": "A11627100", "exp": "2026-08-03", "status": "Delivered", "desc": "PFG EXTRAS T5 \u2014 RENO SO# S096887 / PO# 5438 SHIPPED Jul 27 (Day & Ross, ETA 4-5 days, tracking A11627100, ref WH/OUT/40050). GIT (Simon) confirmed receipt Jul 31 (Day & Ross/Fastfrate delivery, 3 packing slips incl PO 5438). Some pallets arrived DAMAGED - signed as damaged, photos taken.", "job": "PFG EXTRAS T5", "flag": "DAMAGE EXCEPTION: delivered Jul 31 with pallet damage - file carrier/RENO claim"},
    {"id": "SHP-057", "mfg": "RENO Lighting", "so": "S096925", "po": "5439", "ship": "2026-07-28", "carrier": "Day & Ross", "tracking": "A11639512", "exp": "2026-08-03", "status": "Delivered", "desc": "OM CASTLE PARKADE \u2014 RENO SO# S096925 / PO# 5439 SHIPPED Jul 28 (Day & Ross, ETA 4 days, tracking A11639512, ref WH/OUT/40109). GIT (Simon) confirmed receipt Jul 31 (Day & Ross/Fastfrate delivery). Some pallets arrived DAMAGED - signed as damaged, photos taken.", "job": "OM CASTLE PARKADE", "flag": "DAMAGE EXCEPTION: delivered Jul 31 with pallet damage - file carrier/RENO claim"},
    {"id": "SHP-058", "mfg": "RENO Lighting", "so": "S091325", "po": "5303", "ship": "2026-07-27", "carrier": "Day & Ross", "tracking": "MISSING", "exp": "2026-08-03", "status": "Delivered", "desc": "Store 9 / Stock \u2014 recurring stock SO S091325 / PO 5303 reshipped again Jul 27 (Day & Ross, ETA 4-5 days, ref WH/OUT/38817). Third reship of this recurring SO (prior: SHP-001 Jun 12, SHP-023 Jun 26). Delivered Jul 31 (Day & Ross/Fastfrate) but arrived DAMAGED; damaged goods re-shipped again Aug 3 (see SHP-063).", "job": "Store 9 / Stock", "flag": "DAMAGE EXCEPTION: delivered Jul 31 damaged; re-ship issued Aug 3 (SHP-063)"},
    ...
    {"id": "SHP-061", "mfg": "Commercial Lighting (Comlight)", "so": "1803037", "po": "", "ship": "", "carrier": "Local pickup (Delta)", "tracking": "", "exp": "", "status": "Order Placed", "desc": "JORDAN \u2014 PO to Comlight (Sean Loban); order confirmation #1803037 returned Jul 27, 'ready for pickup anytime.' Andrew coordinating collection.", "job": "Jordan", "flag": "Comlight not on approved mfg list \u2014 ready for pickup at Comlight (Delta) since Jul 27; arrange collection & confirm job scope"},
    {"id": "SHP-062", "mfg": "Commercial Lighting (Comlight)", "so": "1803465", "po": "", "ship": "", "carrier": "Local pickup (Delta)", "tracking": "MISSING", "exp": "", "status": "Order Placed", "desc": "BTC - EM BALLAST \u2014 PO to Comlight (Sean Loban); order confirmation #1803465 returned Jul 29. Sean: 'I\u2019ll let you know when this arrives for pickup.' Not yet in stock at Comlight.", "job": "BTC - EM Ballast", "flag": "Comlight not on approved mfg list \u2014 new order Jul 29, awaiting stock arrival at Comlight; monitor for pickup-ready notice"},
    {"id": "SHP-063", "mfg": "RENO Lighting", "so": "S091325", "po": "5303", "ship": "2026-08-03", "carrier": "Day & Ross", "tracking": "A11706479", "exp": "2026-08-09", "status": "In Transit", "desc": "Store 9 / Stock - RENO re-shipped the goods damaged in the Jul 31 delivery (recurring SO S091325 / PO 5303). Day & Ross tracking A11706479, ETA 5-6 days. Track at dayross.com.", "job": "Store 9 / Stock", "flag": "Re-ship of Jul 31 damaged goods - monitor delivery"},
    {"id": "SHP-064", "mfg": "Standard Products", "so": "", "po": "", "ship": "", "carrier": "K&H Dispatch", "tracking": "", "exp": "2026-07-29", "status": "Delivered", "desc": "GIT (Simon) receipt ~Jul 29 - K&H Dispatch delivered 5 boxes of 3ft strip lights from Standard Products (Stanpro). Warehouse arrival; no PO/job on receipt.", "job": "Unspecified (Stanpro strip)", "flag": "No SO/PO on GIT receipt - tag at warehouse to identify job/PO"},
    {"id": "SHP-065", "mfg": "Matteo Lighting", "so": "", "po": "5448", "ship": "", "carrier": "Artika fulfillment (carrier TBD)", "tracking": "MISSING", "exp": "2026-08-04", "status": "In Transit", "desc": "CHAMBER PROPERTIES FANS - PO 5448 (fan samples). Artika (Carla Torrez) advised order sent to fulfillment with ESD Aug 3-4; tracking to follow. Note: mfg attribution tentative (Artika fan program).", "job": "CHAMBER PROPERTIES FANS", "flag": "No tracking # yet - Artika to provide auto tracking; confirm ship/ETA"},
    {"id": "SHP-055", "mfg": "RENO Lighting", "so": "S096887", "po": "5438", "ship": "2026-07-27", "carrier": "Day & Ross", "tracking": "MISSING", "exp": "2026-07-31", "status": "Delivered", "desc": "PFG extras (RENO). SO S096887 / PO 5438 SHIPPED Jul 27 (Day & Ross, ETA 4-5). Arrived LTS/GIT warehouse Jul 31 as part of the 4-pallet Day & Ross + 1 Fastfrate delivery. Andrew flagged some pallets damaged on arrival (joint PO 5303/5438/5439).", "job": "PFG - Extras", "flag": "DAMAGE: some pallets damaged on arrival Jul 31 (joint with PO 5303/5439) - photos taken, file carrier/RENO claim; capture Day & Ross PRO#"},
    {"id": "SHP-056", "mfg": "RENO Lighting", "so": "S096925", "po": "5439", "ship": "2026-07-28", "carrier": "Day & Ross", "tracking": "A11641471", "exp": "2026-08-01", "status": "Delivered", "desc": "OM - CASTLES RENO (balance). SO S096925 / PO 5439 SHIPPED Jul 28 (Day & Ross, ETA 4). First shipping notice had wrong address; RENO rerouted and issued corrected tracking A11641471. Received at LTS/GIT Jul 31 (joint 4-pallet Day & Ross delivery).", "job": "OM - CASTLES RENO", "flag": "DAMAGE: some pallets damaged on arrival Jul 31 - file claim. Address corrected mid-transit (Andrew flagged Jul 28)."},
    {"id": "SHP-057", "mfg": "RENO Lighting", "so": "S091325", "po": "5303", "ship": "2026-08-03", "carrier": "Day & Ross", "tracking": "A11706479", "exp": "2026-08-09", "status": "In Transit", "desc": "PFG - last few stores (REPLACEMENT). RENO SO S091325 / PO 5303 re-shipped Aug 3 (Day & Ross, tracking A11706479, ref WH/OUT/40100, ETA 5-6). Replaces PO 5303 units received damaged Jul 31. Track at dayross.com.", "job": "PFG - Last Few Stores", "flag": "IN TRANSIT: replacement for damaged Jul 31 receipt; ETA ~Aug 9 - confirm GIT receipt and condition on arrival"},
    {"id": "SHP-058", "mfg": "RENO Lighting", "so": "S091325", "po": "5303", "ship": "2026-07-27", "carrier": "Day & Ross", "tracking": "MISSING", "exp": "2026-07-31", "status": "Delivered", "desc": "PFG - last few stores (original). RENO SO S091325 / PO 5303 shipped Jul 27 (Day & Ross, ETA 4-5); received at LTS/GIT Jul 31. Units arrived DAMAGED - RENO re-shipped replacement Aug 3 (see SHP-057).", "job": "PFG - Last Few Stores", "flag": "DAMAGE: received damaged Jul 31; replacement re-shipped Aug 3 (SHP-057) - file carrier/RENO claim"},
    {"id": "SHP-059", "mfg": "Standard Products", "so": "", "po": "", "ship": "2026-07-31", "carrier": "K&H Dispatch", "tracking": "", "exp": "2026-07-31", "status": "Delivered", "desc": "GIT (Simon) receipt Jul 31 - K&H Dispatch delivered 5 boxes of 3ft strip lights from Stanpro (Standard Products) earlier in the week. New warehouse arrival.", "job": "Unspecified (Stanpro 3ft strip)", "flag": "No SO/PO on GIT receipt - tag at warehouse to identify job/PO"},
    {"id": "SHP-060", "mfg": "Nedco West Canada", "so": "5996235", "po": "", "ship": "", "carrier": "", "tracking": "MISSING", "exp": "2026-08-07", "status": "Order Placed", "desc": "HALLMARK ON THE LAKE - PO to Nedco West (Amber Larsen) Jul 31; Nedco order 5996235. Andrew directed release of in-stock items Fri Aug 7, with R31104 RENO-S12R-MCCT-WH (123 pcs) to follow when it arrives. Nedco confirmed instructions passed to supplier Aug 4.", "job": "Hallmark on the Lake", "flag": "PARTIAL: in-stock items release Fri Aug 7 (get carrier/tracking then); R31104 (123 pcs) backordered - track balance shipment"},
    {"id": "SHP-061", "mfg": "CSC LED", "so": "4092331", "po": "", "ship": "2026-08-04", "carrier": "Digital Waybill (Sameday, local)", "tracking": "734114", "exp": "2026-08-04", "status": "Delivered", "desc": "WOODLANDS - R1 CSC - CSC LED order receipt 4092331 (Jul 30), processed for pickup. Digital Waybill order 734114 (Sameday) picked up at CSC LED (Port Coquitlam) for delivery to Intergulf - Woodlands (2377 E 11 Ave) Aug 4.", "job": "Woodlands (R1 CSC)", "flag": "Local same-day delivery direct to Woodlands site - confirm site receipt"},
]
...
HTML = HTML.replace("__LAST_UPDATED__", "Aug 5, 2026")
