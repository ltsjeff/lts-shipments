...
shipments = [
    ...
    {"id": "SHP-064", "mfg": "Matteo Lighting", "so": "", "po": "5448", "ship": "", "carrier": "Artika fulfillment (carrier TBD)", "tracking": "MISSING", "exp": "2026-08-04", "status": "In Transit", "desc": "CHAMBER PROPERTIES FANS — PO 5448 (fan samples). Artika (Carla Torrez) advised order sent to fulfillment with ESD Aug 3-4; tracking to follow. Mfg attribution tentative (Artika fan program).", "job": "CHAMBER PROPERTIES FANS", "flag": "No tracking # 3+ days past ESD (Aug 3-4) — chase Artika for auto tracking # + confirm ship/ETA"},
    {"id": "SHP-065", "mfg": "Nedco West Canada", "so": "5996235", "po": "", "ship": "", "carrier": "Ships to site (via RENO/Nedco)", "tracking": "MISSING", "exp": "2026-08-07", "status": "Order Placed", "desc": "HALLMARK ON THE LAKE — PO to Nedco West (Amber Larsen) Jul 31; Nedco order 5996235. Andrew directed release of in-stock items Fri Aug 7, with R31104 RENO-S12R-MCCT-WH (123 pcs) to follow when it arrives. Nedco confirmed instructions passed to supplier Aug 4.", "job": "Hallmark on the Lake", "flag": "PARTIAL: in-stock items releasing today (Aug 7) — capture carrier/tracking; R31104 (123 pcs) backordered, track balance"},
